...
import { Link2, Palette, Layout, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="flex flex-col min-h-screen pb-7 bg-gray-50">
            ...
            <main className="flex-1 w-full max-w-2xl mx-auto px-4 mt-8">
                <form
                    ...
                    className='bg-white w-full flex flex-col p-8 shadow-xl shadow-gray-200/50 rounded-2xl border border-gray-100'
                >
                    ...
                    <label htmlFor="name" className='text-sm font-semibold text-gray-600 mb-2 flex items-center gap-2'>
                        Nome do link
                    </label>
                    <Input
                        id="name"
                    ...
                    >
                        Cadastrar Link <Link2 size={20} className="inline-block ml-2" />
                    </button>
